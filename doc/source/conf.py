...
.. |PACKAGE_CODE| replace:: `Project Code`_
.. _%s Homepage: http://fricas.sourceforge.net
.. _Project Code: https://github.com/fricas/fricas
""" % (project.lower(), project, project, project)
